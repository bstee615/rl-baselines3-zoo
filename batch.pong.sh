...
python train.py --algo ppo --env PongNoFrameskip-v4 -tb results/zoo/ppo --log-folder results/zoo --eval-freq 10000 --eval-episodes 10 --save-freq 100000
